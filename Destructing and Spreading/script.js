...
let newStudent = {
  ...
  skills: {
    ...
    frontEnd: [
      ...
      { skill: "Bootstrap", level: 8 },  // Adding Bootstrap to frontEnd
    ],
    backEnd: [
      ...student.skills.backEnd,
      { skill: "Express", level: 9 },  // Adding Express to backEnd
    ],
    dataBase: [
      ...student.skills.dataBase,
      { skill: "SQL", level: 8},  // Adding SQL to dataBase
    ],
    dataScience: [
      ...student.skills.dataScience, "SQL" // Adding SQL to dataScience
    ],
  },
};
